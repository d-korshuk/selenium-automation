...
class TestPositiveScenarios:
    ...
    def test_positive_login(self, driver):
        ...
        assert logged_in_page.expected_url == logged_in_page.current_url, "Actual url doesn't match the expected one"
        assert logged_in_page.header == "Logged In Successfully", "Header is not expected"
        assert logged_in_page.is_logout_button_displayed(), "Logout button is missing"
